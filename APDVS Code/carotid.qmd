...
author-title: Angela Kokkosis, MD, FACS and Michael Malinowski, MD, MEHP, FACS
format: html
editor: visual
...
# Carotid Disorders, APDVS Medical Student Curriculum
...
```{r echo=FALSE}
<iframe title="Libsyn Player" style="border: none" src="//html5-player.libsyn.com/embed/episode/id/20601968/height/90/theme/custom/thumbnail/yes/direction/forward/render-playlist/no/custom-color/000000/" height="90" width="100%" scrolling="no"  allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
```
